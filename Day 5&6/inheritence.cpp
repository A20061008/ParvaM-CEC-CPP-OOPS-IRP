...
class Parent{
    ...
    int  getFamilyInfo(){ //getter
     ...
     //by default : dervide class uses private accessbility mode
     // 1) if dervided class uses private accessibilty mode then public data &
        // member function of the base class  will be private
     // 2) if dervided class uses public accessibilty mode then public data &
